...
public class UpdateSecurePassword {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (args.length < 1) {
            System.out.println("Update Password must specify table name");
            System.out.println("Usage: UpdateSecurePassword <user-table>");
            System.exit(1);
        }
        ...
        if (args[0].equals("customers")) {
            ...
            while (rs.next()) {
                ...
                String updateQuery = String.format("UPDATE customers SET password='%s' WHERE id=%s;",
                        encryptedPassword,
                        id);
